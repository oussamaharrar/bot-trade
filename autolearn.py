...
def main():
    ...
    if len(df) < 100:
        logging.info("Not enough data to retrain the model. Minimum required: 100 rows.")
        return
    ...
    if prev_best is not None:
        ...
        logging.info(f"Previous best F1: {prev_best['f1_score']:.4f}")
    ...
    logging.info(f"📈 Evaluation logged to {EVAL_LOG}")
